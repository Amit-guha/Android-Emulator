...
public class ImageAdapter3 extends RecyclerView.Adapter<ImageAdapter3.MyviewHolder> {
    ...
    public ImageAdapter3(Context context, List<Upload> uploadList) {
    ...
    public MyviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.recyler_gridview, parent, false);
    ...
    public void onBindViewHolder(MyviewHolder holder, int position) {
        ...
        //String url=upload.getmImageUrl().toString();
